...
export const ThemeTokens = z.object({
  palette: z.object({
    ...
    muted: z.string(), surface: z.string(),
  }),
...
export const Slide = z.discriminatedUnion("layout", [
  z.object({ layout: z.literal("cover"), kicker: z.string().optional(), title: z.string(),
             subtitle: z.string().optional(), image: Img.optional() }),
  z.object({ layout: z.literal("split"), side: z.enum(["left", "right"]),
             kicker: z.string().optional(), title: z.string(), body: z.string().optional(),
             bullets: z.array(z.string()).optional(), image: Img }),
  z.object({ layout: z.literal("fullbleed"), title: z.string().optional(),
             body: z.string().optional(), image: Img, overlay: z.number().optional() }),
  z.object({ layout: z.literal("statement"), text: z.string(), attribution: z.string().optional() }),
  z.object({ layout: z.literal("kpi-grid"), title: z.string().optional(),
             items: z.array(z.object({ value: z.string(), label: z.string() })) }),
  z.object({ layout: z.literal("agenda"), title: z.string(), part: z.string().optional(),
             rows: z.array(z.object({ time: z.string(), title: z.string(), desc: z.string().optional() })) }),
  z.object({ layout: z.literal("timeline"), title: z.string(),
             phases: z.array(z.object({ label: z.string(), items: z.array(z.string()) })) }),
  z.object({ layout: z.literal("table"), title: z.string().optional(), head: z.array(z.string()),
             rows: z.array(z.array(z.string())),
             total: z.object({ label: z.string(), value: z.string() }).optional() }),
  z.object({ layout: z.literal("grid"), title: z.string().optional(), cols: z.union([z.literal(2), z.literal(3), z.literal(4)]),
             cells: z.array(z.object({ image: Img.optional(), title: z.string(), caption: z.string().optional() })) }),
  z.object({ layout: z.literal("quote"), text: z.string(), author: z.string(),
             role: z.string().optional(), voiceId: z.string().optional() }),
  z.object({ layout: z.literal("divider"), label: z.string().optional(), image: Img.optional() }),
  z.object({ layout: z.literal("steps"), title: z.string().optional(),
             steps: z.array(z.object({ num: z.string(), name: z.string(), desc: z.string().optional() })) }),
  z.object({ layout: z.literal("qty-list"), title: z.string().optional(),
...
export const Deck = z.object({
  meta: z.object({
    title: z.string(), subtitle: z.string().optional(), client: z.string().optional(),
    date: z.string().optional(), lang: z.enum(["es", "en"]).default("es"),
...
export const deckText = (d: Deck): string =>
  d.slides.map((s) => Object.entries(s)
